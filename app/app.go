...
// PassmosApp implements an extended ABCI application. It contains a BaseApp,
...
func (app *PassmosApp) initChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
